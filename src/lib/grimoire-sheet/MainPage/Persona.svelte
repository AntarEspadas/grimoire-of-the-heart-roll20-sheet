...
<div class="persona">
	...
	<div class="grid">
		<LabeledInput i18n="name" name="Name" attribute="attr_persona_name" />
		<LabeledInput i18n="level-short" name="Lv" attribute="attr_persona_level" />
		<LabeledInput i18n="spirit-points-short" name="SP" attribute="attr_spell_points" />
