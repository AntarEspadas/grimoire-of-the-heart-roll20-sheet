...
<div class="items">
	...
	<div class="repeating">
		<fieldset class="repeating_items">
			...
			>
				<div class="always">
					<ChippedTextField name="attr__item_name" />
					<ChippedTextField name="attr__item_amount" type="number" />
				</div>
				<svelte:fragment slot="edit">
					<Label i18n="description">Description</Label>
					<ChippedTextArea name="attr__item_description" />
				</svelte:fragment>
			</EditableField>
			<div class="divider" />
		</fieldset>
...
<style lang="scss">
	.items {
		...
		:global(.editable-field .edit .chipped-textarea) {
			resize: vertical;
			--chip-size: 10px;
		}
	}
